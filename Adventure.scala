...
class Adventure:
  ...
  private val remote = Item("remote", "It's the remote control for your TV.\nWhat it was doing in the forest, you have no idea.\nProblem is, there's no battery.")
  ...
  def isComplete = this.player.location == this.destination && this.player.has(battery.name) && this.player.has(remote.name)
